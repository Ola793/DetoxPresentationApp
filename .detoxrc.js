...
module.exports = {
  ...
  apps: {
    ...
    "android.debug": {
      ...
      build:
        "cd android && bash gradlew assembleDebug assembleAndroidTest -DtestBuildType=debug || gradlew.bat assembleDebug assembleAndroidTest -DtestBuildType=debug",
      reversePorts: [8081],
    },
    "android.release": {
      type: "android.apk",
      ...
      build:
        "cd android && bash gradlew assembleRelease assembleAndroidTest -DtestBuildType=release || gradlew.bat assembleRelease assembleAndroidTest -DtestBuildType=release",
    },
  },
  devices: {
    simulator: {
